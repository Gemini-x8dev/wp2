...
if ( ! class_exists( 'MyPreview_Conj_Lite' ) ) :
	...
	class MyPreview_Conj_Lite {
		...
		public function admin_enqueue() {
			...
			wp_register_script( 'mypreview-conj-upsell-scripts', get_theme_file_uri( '/assets/admin/js/upsell' . $suffix . '.js' ), array( 'jquery' ) , defined("MYPREVIEW_CONJ_THEME_VERSION") || 0.1, TRUE );
