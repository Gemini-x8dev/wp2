...
class API {
    ...
    function __construct()
    {
        ...
        add_action('woocommerce_before_checkout_form',[$this->check,'beforeCheckout']);
        add_action('woocommerce_review_order_after_cart_contents',[$this->check,'beforeCart']);
    }
